...
@Component({
  selector: 'app-choose-players-for-team',
  templateUrl: './choose-players-for-team.page.html',
  styleUrls: ['./choose-players-for-team.page.scss'],
})
export class ChoosePlayersForTeamPage implements OnInit {
  title="Players List"; 
